//package com.self.andyl.hdhmenu;
...
public class HDH_DINING_HALL extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hdh_dining_hall);
        ...
        sixtyfour.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              //Attempt to open another activity (Dining Hall Menu)
                Intent intent = new Intent(HDH_DINING_HALL.this, testClick.class);
